                    ...
                    <div className="col l6 m12 valign-wrapper">
                        <div className="content valign">
                            ...
                            <div className="social">
                                ...
                                <a href="https://instagram.com/dev_chii" target="_blank" rel="noopener noreferrer" data-delay="50" data-tooltip="Instagram" className="btn-floating tooltipped z-depth-0 transparent center"><i className="mdi mdi-instagram"></i></a>
